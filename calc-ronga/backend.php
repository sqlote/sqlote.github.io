...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["precioContado"])) {
    ...
    $cotizaciones = array(
        ...
        // SUCREDITO 3 Y 6
        "SUCREDITO 12 SOLICITADO" => $precioContado * 1.5, 
        "SUCREDITO 12 CTAS" => ($precioContado * 1.5) / 12,
        "SUCREDITO 6 SOLICITADO" => $precioContado * 1.25, 
        "SUCREDITO 6 CTAS" => ($precioContado * 1.25) / 6,
